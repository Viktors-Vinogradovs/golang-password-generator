...
Приложение использует `crypto/rand` для генерации криптографически стойких случайных чисел. `math/rand` не используется.

## Автор

Тестовое задание для позиции Junior Golang Developer
